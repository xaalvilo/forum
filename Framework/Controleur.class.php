...
{
    /* @var string action � r�aliser par le controleur */
    private $_action;

    /* @var Requete requ�te entrante (utilisable par les classes d�riv�es) */
    protected $_requete;

    /* @var Reponse reponse HTTP sortante */
    protected $_reponse;
    ...
    */
    ...
    public function initForm($nomEntite,array $donnees = array())
    {
        ...
        $formBuilder = new $NamespaceClasseFormBuilder($entite,$donnees);
