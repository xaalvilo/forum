    ...
    protected function executerRequete($sql,$params = null,$entite)
    {
        ...
        else
        {
            ...
            $resultat = self::getBdd()->prepare($sql);
         	...
         	// si erreur a l'execution, envoyer le code erreur sql
        ...
        //d�finit le mode de r�cup�ration par d�faut des donn�es en BDD : ici sous forme d'objets de la classe $entité
